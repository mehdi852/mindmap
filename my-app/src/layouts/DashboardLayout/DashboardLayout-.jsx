...
const navigation = [
  { name: "Dashboard" , href: "/dashboard/main", icon: HomeIcon, current: true },
  { name: "Team", href: "/dashboard/team", icon: UsersIcon, current: false },
  { name: "Projects", href: "/dashboard/team", icon: FolderIcon, current: false },
  { name: "Builder", href: "#", icon: WrenchIcon, current: false },
