...
import { RocketLaunch,Briefcase,Users,Shield,Key,Sliders,EnvelopeOpen,Book } from "@phosphor-icons/react";
    ...
    <div className="relative flex flex-row w-full h-full min-h-[35rem]">
      ...
      >
        ...
        <Sidebar.Nav>
          ...
          <Sidebar.Nav.Section>
            ...
            <Sidebar.Nav.Section.Item icon={<Key />} label="Contact" href="#" />
      ...
      >
        ...
        <header className="flex flex-row sticky top-0 px-8 items-center  bg-white border-b border-b-gray-100 w-full shadow-sm min-h-[4rem]">
          <span>Navbar {JSON.stringify(expanded)} </span>
